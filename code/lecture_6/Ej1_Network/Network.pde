class Network {
  ...
  // Constructor
  Network() {
    this.p1 = new Particle((int) random(0, width), (int) random(0, height));
    this.p2 = new Particle((int) random(0, width), (int) random(0, height));
    this.p3 = new Particle((int) random(0, width), (int) random(0, height));
    this.p4 = new Particle((int) random(0, width), (int) random(0, height));
  }
